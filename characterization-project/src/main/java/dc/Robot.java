...
public class Robot extends TimedRobot {
  ...
  static private double ENCODER_EDGES_PER_REV = 360 / 4.;
  ...
  public void robotInit() {
    ...
    PWMVictorSPX rightMotor1 = new PWMVictorSPX(0);

    SpeedController[] leftMotors = new SpeedController[1];
    leftMotors[0] = new PWMVictorSPX(3);

    SpeedController[] rightMotors = new SpeedController[1];
    rightMotors[0] = new PWMVictorSPX(1);
